...
def file_exists_check():
    """Check if the 'Assignment_0.py' file exists"""
    if not os.path.isfile("Assignment_0.py"):
        raise check50.Failure("The 'Assignment_0.py' file does not exist")
...
def stats_check1():
    ...
    actual = check50.run("python3 Assignment_0.py").stdin(sample_list).stdout()
