...
def check_cases():
    ...
    actual = check50.run("python3 Assignment_0.py").stdin("XXXXX").stdin("XXXXX").stdout()
    expected = "10"
...
def check_cases2():
    ...
    actual = check50.run("python3 Assignment_0.py").stdin("XXXXX").stdin("XXXXXXXXXX").stdout()
    expected = "15"
...
def check_cases3():
    ...
    actual = check50.run("python3 Assignment_0.py").stdin("XXXXXXXXXX").stdin("XXXXXXXXXXX").stdout()
    expected = "21"
