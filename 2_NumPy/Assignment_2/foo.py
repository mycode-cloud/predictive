...
def check_cases3(exists):
    ...
    actual00 = check50.run("python3 Assignment_2.py").stdout()
    ...
    actual0 = check50.run("python3 Assignment_2.py").stdout()
    expected0 = "\[\[-2159 -2069\]\n \[-1799 -1709\]\]"
    ...
    actual2 = check50.run("python3 Assignment_2.py").stdout()
    ...
    actual3 = check50.run("python3 Assignment_2.py").stdout()
    ...
    actual4 = check50.run("python3 Assignment_2.py").stdout()
    expected4 = "10640"
